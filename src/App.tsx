...
const nav = [
  ...
  { view: 'messages' as AppView, label: 'Berichten', icon: MessagesSquare },
...
function ProfilePage({ profile, currentId, posts, following, followers, onFriendAction, onMessage, onBlock, onSettings, onModerate, online, onReset }: { profile: Profile; currentId: string; posts: ReturnType<typeof useSocialApp>['posts']; following: string[]; followers: string[]; onFriendAction: (id: string) => void; onMessage: (id: string) => void; onBlock: (id: string) => void; onSettings: () => void; onModerate: () => void; online: boolean; onReset: () => void }) {
