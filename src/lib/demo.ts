...
export const demoPosts: Post[] = [
  {
    ...
    createdAt: new Date(Date.now() - 25 * 60_000).toISOString(), likes: 128, liked: false, likedBy: ['p2', 'p3'], reactionCounts: { like: 98, love: 20, fire: 10 }, reactionsByUser: { p2: 'love', p3: 'fire' }, revisions: [], visibility: 'public',
  ...
  },
  {
    ...
    imageUrls: [],
    createdAt: new Date(Date.now() - 2.2 * 3_600_000).toISOString(), likes: 84, liked: true, likedBy: ['me', 'p1', 'p5'], reaction: 'fire', reactionCounts: { like: 51, love: 8, fire: 25 }, reactionsByUser: { me: 'fire', p1: 'like', p5: 'love' }, revisions: [], visibility: 'public',
    comments: [
  ...
  },
  {
    ...
    createdAt: new Date(Date.now() - 5.5 * 3_600_000).toISOString(), likes: 311, liked: false, likedBy: ['p1', 'p4'], reactionCounts: { like: 240, love: 45, fire: 26 }, reactionsByUser: { p1: 'love', p4: 'fire' }, revisions: [], visibility: 'public', comments: [],
  },
  {
    ...
    createdAt: new Date(Date.now() - 22 * 3_600_000).toISOString(), likes: 201, liked: false, likedBy: ['p2'], reactionCounts: { like: 170, love: 31 }, reactionsByUser: { p2: 'love' }, revisions: [], visibility: 'public', comments: [],
  },
]
